# Personal-Portfolio
WELCOME to my Personal Portfolio Project!!! :) <br>
...
<ul>
  <li><h3>Responsive Design:</h3>
    The website layout adapts seamlessly to different screen sizes, providing an optimal viewing experience for all users. <br>
    ...
    3. Samrtphones: </br>
    <img width="390" alt="image" src="https://github.com/Steven012820041010/Personal-Portfolio/assets/68784611/9889663e-3ba9-4c2a-9e40-d1a960f49e34"></li>
  <li><h3> Interactive Animations:</h3>
    Various interactive features have been incorporated using JavaScript, adding an extra touch of delight to the user experience. </li>
  <li><h3> Scroll Animations:</h3>
    As you navigate through the pages, elements come to life with smooth scrolling animations, making the website engaging and visually   appealing.</li>
  <li><h3> Heart Animations: </h3>
    Prepare to be charmed! Keep an eye out for adorable heart animations sprinkled throughout the website, bringing some warmth and love.<br>
    <img width="1439" alt="image" src="https://github.com/Steven012820041010/Personal-Portfolio/assets/68784611/101ffc97-069a-43b6-a4d6-013d12404cc9">

</li>
  <li><h3> Content Organization:</h3>
